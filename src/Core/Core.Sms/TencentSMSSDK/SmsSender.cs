...
namespace Core.Sms.TencentSMSSDK
{
    namespace Sms
    {
        class SmsKeyStr
        {
            ...
            /// 腾讯云短信SdkAppId
            /// </summary>
            public static int SdkAppId = 1400049083;//CommonConst.SdkAppId;

            /// <summary>
            /// 腾讯云短信AppKey
            /// </summary>
            public static string AppKey = "fd3b2566da3ff029075027a14b646900";//CommonConst.AppKey;
        ...
        class SmsSingleSender
        {
            ...
            {
                this.sdkappid = SmsKeyStr.SdkAppId;
                this.appkey = SmsKeyStr.AppKey;
            }
