...
{
    public interface IMainMaterialItemRepository : IPlatformBaseService<T_MainMaterialItem>
    {
        /// <summary>
        /// 获取所有数据
        /// </summary>
        Task<List<T_MainMaterialItem>> GetList();

        Task<List<MainMaterialItemWithCategory>> GetMaterialItemWithCategoryList();
    }
}
