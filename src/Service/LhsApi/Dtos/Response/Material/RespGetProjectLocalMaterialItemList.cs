...
namespace LhsApi.Dtos.Response.Material
{
    ...
    /// 地采明细列表，除了安装
    /// </summary>
    public class RespGetProjectLocalMaterialItemList
    {
        /// <summary>
        /// id
        /// </summary>
    ...
    /// 地采明细列表,待安装单独处理
    /// </summary>
    public class RespGetProjectLocalMaterialItem_9
    {
        /// <summary>
        /// id
        /// </summary>
    ...
    public class LocalMaterialItemList
    {
        public LocalMaterialItemList(EnumMaterialItemStatus status, string statusName)
        {
            Status = status;
